...
//!
//! Chosen at run time with `GIPNY_EMBEDDED_I2P=1` while it proves itself;
//! SAM stays the default.
...
/// Whether this run uses the in-process router.
pub fn enabled() -> bool {
    std::env::var("GIPNY_EMBEDDED_I2P").is_ok_and(|v| v == "1")
}
