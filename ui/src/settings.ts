      ...
      h('div', { class: 'modal-body' },
        ...
        (() => {
          ...
          updateSection.append(
            ...
            updErr,
            (() => {
              const line = h('div', { class: 'hint', style: { marginTop: '8px' } },
              ...
              Api.updateAsksForRoot().then((asks) => {
                if (!asks) return;
                line.textContent = 'Приложение установлено пакетом .deb, поэтому обновление ставит '
                  + 'менеджер пакетов и спрашивает пароль администратора. Проверка и загрузка идут '
                  + 'сами, а установка — по кнопке «Установить сейчас».';
              }).catch(() => {});
              return line;
            })(),
          );
